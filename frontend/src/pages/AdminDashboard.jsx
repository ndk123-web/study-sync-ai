...
const AdminDashboard = () => {
  ...
  const [adminStats] = useState({
    ...
    topicWiseData: [
      { topic: "React Development", enrollments: 856, courses: 3, completions: 421 },
      { topic: "Python Programming", enrollments: 743, courses: 2, completions: 489 },
      { topic: "Data Science & AI", enrollments: 612, courses: 2, completions: 145 },
      { topic: "JavaScript Fundamentals", enrollments: 534, courses: 2, completions: 298 },
      { topic: "Node.js Backend", enrollments: 423, courses: 1, completions: 89 },
      { topic: "Flutter Mobile Dev", enrollments: 288, courses: 2, completions: 156 },
    ],
    ...
    recentActivity: [
      { user: "Alice Johnson", action: "enrolled in React Advanced", time: "2 min ago", type: "enrollment" },
      { user: "Bob Smith", action: "completed Python Basics", time: "5 min ago", type: "completion" },
      { user: "Carol Davis", action: "started Data Science course", time: "8 min ago", type: "enrollment" },
      { user: "David Wilson", action: "enrolled in Flutter course", time: "12 min ago", type: "enrollment" },
      { user: "Emma Brown", action: "completed JS Fundamentals", time: "15 min ago", type: "completion" },
    ]
  });
  ...
  const CustomTooltip = ({ active, payload, label }) => {
    ...
    return (
      <div className={`px-3 py-2 rounded-lg border shadow-lg ${isDark ? "bg-gray-800 border-gray-700 text-gray-100" : "bg-white border-gray-200 text-gray-800"}`}>
      ...
      <main className="pt-4">
        <div className="px-4 py-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            {/* Total Users */}
            <div className={`${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6 hover:shadow-lg transition-all duration-300`}>
            ...
            <div className={`${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6 hover:shadow-lg transition-all duration-300`}>
              ...
              <p className={`text-3xl font-bold ${isDark ? "text-white" : "text-gray-900"}`}>
                {Math.round((adminStats.totalCompletions / adminStats.totalEnrollments) * 100)}%
              </p>
              <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"} mt-2`}>
                Average completion
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className={`${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300`}>
              ...
              <p className={`text-3xl font-bold text-blue-500 mb-2`}>
                {adminStats.enrollmentBreakdown.courses.toLocaleString()}
              </p>
            ...
            <div className={`${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300`}>
              ...
              <p className={`text-3xl font-bold text-red-500 mb-2`}>
                {adminStats.enrollmentBreakdown.videos.toLocaleString()}
              </p>
              <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}>
            ...
            <div className={`${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300`}>
              ...
              <p className={`text-3xl font-bold text-purple-500 mb-2`}>
                {adminStats.enrollmentBreakdown.pdfs.toLocaleString()}
              </p>
              <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}>
            ...
            <div className="lg:col-span-2">
              <div className={`${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6`}>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className={`text-xl font-bold ${isDark ? "text-white" : "text-gray-900"} flex items-center space-x-2`}>
                      <BarChart3 className="w-6 h-6 text-blue-500" />
                      <span>User Activity Trends</span>
                    </h3>
                    <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"} mt-1`}>
                      Monthly overview of user registrations, enrollments, and completions for {selectedYear}
                    </p>
                  </div>
                  <select 
                    value={selectedYear}
                    onChange={(e) => setSelectedYear(parseInt(e.target.value))}
                    className={`px-3 py-2 rounded-lg border text-sm font-medium ${isDark ? "bg-gray-700 border-gray-600 text-white" : "bg-white border-gray-300 text-gray-900"} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                  >
                ...
                <ChartContainer height={300}>
                  <Recharts.LineChart data={adminStats.userActivityData[selectedYear]}>
            ...
            <div className="lg:col-span-1">
              <div className={`${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6`}>
                ...
                <div className="space-y-6">
                  ...
                  <div className={`p-4 rounded-xl ${isDark ? "bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-800/50" : "bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200"}`}>
                    <div className="flex items-center justify-between mb-2">
                      <span className={`text-sm font-medium ${isDark ? "text-green-300" : "text-green-700"}`}>
                        🏆 Top Performing Course
                      </span>
                    </div>
                    <h4 className={`font-bold ${isDark ? "text-white" : "text-gray-900"} mb-1`}>
                      Python Programming Fundamentals
                    </h4>
                    <p className={`text-sm ${isDark ? "text-green-400" : "text-green-600"} font-semibold`}>
                      75% completion rate • 387 students
                    </p>
                  </div>

                  {/* Most Popular Topic */}
                  <div className={`p-4 rounded-xl ${isDark ? "bg-gradient-to-r from-blue-900/30 to-indigo-900/30 border border-blue-800/50" : "bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200"}`}>
                    <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className={`p-3 rounded-lg text-center ${isDark ? "bg-purple-900/30 border border-purple-800/50" : "bg-purple-50 border border-purple-200"}`}>
                    ...
                    <div className={`p-3 rounded-lg text-center ${isDark ? "bg-orange-900/30 border border-orange-800/50" : "bg-orange-50 border border-orange-200"}`}>
            ...
            <div className={`${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6`}>
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto custom-scrollbar">
                {adminStats.courseData.map((course, index) => (
                  <div key={course.id} className={`p-4 rounded-xl border ${isDark ? "border-gray-700 bg-gray-700/30" : "border-gray-200 bg-gray-50"} hover:shadow-md transition-all duration-200`}>
            ...
            <div className={`${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6`}>
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto custom-scrollbar">
                {adminStats.recentActivity.map((activity, index) => (
                  <div key={index} className={`flex items-center space-x-4 p-4 rounded-xl border ${isDark ? "border-gray-700 bg-gray-700/30" : "border-gray-200 bg-gray-50"} hover:shadow-md transition-all duration-200`}>
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                      ...
                      {activity.type === "enrollment" ? (
                        <BookOpen className={`w-5 h-5 ${activity.type === "enrollment" ? "text-blue-500" : "text-green-500"}`} />
                      ) : (
                    ...
                    <div className="flex-1">
                      <p className={`font-medium ${isDark ? "text-white" : "text-gray-900"}`}>
                        <span className="text-blue-500">{activity.user}</span> {activity.action}
                      </p>
                      <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                        {activity.time}
                      </p>
          ...
          <div className={`mt-8 ${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border rounded-2xl p-6`}>
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className={`text-xl font-bold ${isDark ? "text-white" : "text-gray-900"} flex items-center space-x-2`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-h-96 overflow-y-auto custom-scrollbar pr-2">
              {adminStats.topicWiseData.map((item, index) => (
                <div key={index} className={`p-6 rounded-xl border ${isDark ? "border-gray-700 bg-gray-700/30" : "border-gray-200 bg-gray-50"} hover:shadow-lg transition-all duration-200`}>
                  <div className="flex items-center justify-between mb-4">
                    <h4 className={`font-bold text-lg ${isDark ? "text-white" : "text-gray-900"}`}>
                      {item.topic}
                    </h4>
                    <span className={`text-sm px-3 py-1 rounded-full ${isDark ? "bg-blue-900/30 text-blue-300" : "bg-blue-100 text-blue-800"}`}>
                  ...
                  <div className="space-y-3 mb-4">
                    <div className="flex justify-between items-center">
                      <span className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}>Total Enrollments</span>
                      <span className={`font-semibold ${isDark ? "text-blue-400" : "text-blue-600"}`}>
                        {item.enrollments.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}>Completions</span>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className={`w-full h-3 rounded-full ${isDark ? "bg-gray-600" : "bg-gray-200"}`}>
                      <div 
          ...
          {/* Revenue Logic Note */}
          <div className={`mt-8 p-6 rounded-2xl border-2 border-dashed ${isDark ? "border-gray-600 bg-gray-800/50" : "border-gray-300 bg-gray-50/50"}`}>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <div className={`space-y-2 text-sm ${isDark ? "text-gray-300" : "text-gray-700"}`}>
                  <p><strong>Option 1:</strong> Premium Subscription - Users pay monthly/yearly for premium features</p>
                  <p><strong>Option 2:</strong> Course Certificates - Charge for verified certificates after course completion</p>
                  <p><strong>Option 3:</strong> Advanced AI Features - Premium AI tutoring, personalized learning paths</p>
                  <p><strong>Option 4:</strong> Corporate Training - Bulk enrollment packages for companies</p>
                  <p className="pt-2 text-xs opacity-75">
                    Currently all courses are free. Revenue tracking will be implemented based on chosen monetization strategy.
                  </p>
                </div>
              </div>
            </div>
