...
const Courses = () => {
  ...
  const courses = [
    {
      ...
      description: "Master React Hooks with hands-on projects and real-world examples.",
      lessons: 24,
    ...
    },
    {
      ...
      description: "Build complete web applications with Node.js, React, and MongoDB.",
      lessons: 36,
  ...
  const CourseCard = ({ course }) => (
    <div className={`${isDark ? 'bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700' : 'bg-gradient-to-br from-white to-gray-50 border-gray-200'} 
                     ...
                     ${isDark ? 'shadow-lg shadow-gray-900/20' : 'shadow-lg shadow-gray-200/50'}`}>
      ...
      <div className="relative overflow-hidden">
        ...
        {/* Level Badge */}
        <div className={`absolute bottom-4 left-4 px-3 py-1 rounded-full text-xs font-semibold backdrop-blur-sm ${
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <span className={`inline-block px-3 py-1 rounded-full text-xs font-bold mb-3 ${
              isDark ? 'bg-gradient-to-r from-emerald-500/20 to-teal-500/20 text-emerald-400 border border-emerald-500/30' : 'bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-700 border border-emerald-200'
            }`}>
              {course.category}
            </span>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
          <div className={`flex items-center space-x-2 p-2 rounded-lg ${isDark ? 'bg-gray-700/50' : 'bg-gray-100/50'}`}>
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold text-emerald-500">{course.price}</div>
            </div>
          </div>
  ...
  return (
    <div className={`min-h-screen transition-all duration-700 relative ${
      isDark ? "bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white" : "bg-gradient-to-br from-gray-50 via-white to-gray-100 text-gray-900"
    }`}>
      ...
      <div className="flex">
        ...
        <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} 
                        ...
                        ${isDark ? 'bg-gradient-to-b from-gray-800 to-gray-900 border-gray-700' : 'bg-gradient-to-b from-white to-gray-50 border-gray-200'} 
          ...
          <div className="p-6 h-full overflow-y-auto">
            ...
            {/* Search */}
            <div className="mb-8">
              <label className="block text-sm font-bold mb-3 text-emerald-500">🔍 Search Courses</label>
            ...
            {/* Categories */}
            <div className="mb-8">
              <label className="block text-sm font-bold mb-4 text-emerald-500">📚 Categories</label>
            ...
            {/* Stats */}
            <div className={`p-6 rounded-2xl border-2 ${isDark ? 'bg-gradient-to-br from-gray-700/50 to-gray-800/50 border-gray-600' : 'bg-gradient-to-br from-gray-50 to-white border-gray-200'} backdrop-blur-sm shadow-xl`}>
        ...
        <div className="flex-1 lg:ml-0">
          ...
          {/* Top Bar */}
          <div className={`sticky top-20 z-20 ${isDark ? 'bg-gray-900/95' : 'bg-gray-50/95'} 
                          backdrop-blur-sm border-b ${isDark ? 'border-gray-700' : 'border-gray-200'} 
                          px-4 py-4`}>
            <div className="flex items-center justify-between">
