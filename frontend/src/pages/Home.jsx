...
const Home = () => {
  ...
  const testimonials = [
    {
      ...
      content:
        "StudySync AI has revolutionized how I study. The AI summaries save me hours, and the progress tracking keeps me motivated!",
      avatar:
        "https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah&backgroundColor=b6e3f4&eyes=happy&mouth=smile",
      rating: 5,
    },
    {
      ...
      content:
        "The chatbot feature is incredible. It's like having a personal tutor available 24/7 to answer my questions.",
      avatar:
        "https://api.dicebear.com/7.x/avataaars/svg?seed=Michael&backgroundColor=c0aede&eyes=default&mouth=smile",
      rating: 5,
    },
    {
      name: "Emily Johnson",
      ...
      content:
        "I've improved my GPA by 0.8 points since using StudySync AI. The personalized study plans are game-changing!",
      avatar:
        "https://api.dicebear.com/7.x/avataaars/svg?seed=Emily&backgroundColor=ffd93d&eyes=happy&mouth=smile",
      rating: 5,
    },
  ];
  ...
  const howItWorks = [
    {
      ...
      description:
        "Add YouTube videos, PDFs, or search for topics using our AI-powered search engine",
    ...
    },
    {
      ...
      title: "AI Analysis",
      description:
        "Our advanced AI processes your content, extracting key insights and creating comprehensive summaries",
    ...
    },
    {
      ...
      description:
        "Chat with AI, take notes, track progress, and receive personalized recommendations for optimal learning",
  ...
  return (
    ...
    >
      <Helmet>
        <title>StudySyncAI</title>
        <meta
          name="description"
          content="Revolutionize your learning with StudySync AI - the ultimate AI-powered study assistant that transforms YouTube videos and study materials into personalized learning experiences."
        />
      </Helmet>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className={`absolute top-20 -left-20 w-72 h-72 rounded-full blur-3xl opacity-8 animate-blob-morph ${
            isDark
        ...
        ></div>
        <div
          className={`absolute top-40 -right-20 w-96 h-96 rounded-full blur-3xl opacity-6 animate-blob-morph animation-delay-2000 ${
            isDark
        ...
        ></div>
        <div
          className={`absolute -bottom-20 left-1/3 w-80 h-80 rounded-full blur-3xl opacity-5 animate-blob-morph animation-delay-4000 ${
            isDark
      ...
      <section className="relative container mx-auto px-4 py-20 md:py-32">
        ...
        >
          ...
          <div className="professional-highlight mb-12">
            ...
            >
              StudySync AI revolutionizes education by transforming YouTube
              videos and study materials into
              <span className="font-semibold text-emerald-500">
                {" "}
                personalized learning experiences
              </span>
              . Get AI-powered summaries, interactive quizzes, and track your
              progress with cutting-edge technology.
            </p>
          </div>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 opacity-10">
                    <div
                      className={`text-6xl bg-gradient-to-br ${stat.color} bg-clip-text text-transparent`}
                    >
                      {stat.icon}
                    </div>
                  </div>
      ...
      >
        ...
        >
          ...
          >
            Our comprehensive suite of AI-powered tools transforms your study
            sessions into efficient, personalized learning experiences
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 opacity-20 group-hover:opacity-40 transition-opacity">
                <div
                  className={`w-16 h-16 rounded-full bg-gradient-to-br ${feature.gradient} blur-xl`}
                ></div>
              </div>
              ...
              <div className="relative z-10">
                ...
                {/* Title */}
                <h3
                  className={`text-xl font-bold mb-4 group-hover:text-emerald-500 transition-colors ${
                ...
                {/* Learn more link */}
                <div
                  className={`flex items-center gap-2 text-sm font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 ${
        ...
        <div className="mt-20">
          <div className={`text-center mb-12`}>
            ...
            >
              Real examples of how StudySync AI transforms your learning
              experience
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="text-center">
                ...
                >
                  Hours spent manually taking notes, struggling to understand
                  complex topics, and difficulty tracking learning progress
                </p>
              </div>
            </div>
            ...
            >
              <div className="text-center">
                ...
                >
                  Instant AI summaries, interactive learning, personalized
                  progress tracking, and 5x faster comprehension
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {howItWorks.map((step, index) => (
              <div
                key={index}
                className={`relative group text-center transform transition-all duration-700 delay-${
                  index * 200
                } ${
                  isVisible.features
                    ? "translate-y-0 opacity-100"
              ...
              >
                ...
                <div
                  className={`relative p-8 rounded-3xl border backdrop-blur-sm transition-all duration-500 hover:scale-105 hover:shadow-xl ${
                    isDark
                ...
                >
                  {/* Step number */}
                  <div
                    className={`absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full bg-gradient-to-r ${step.color} text-white flex items-center justify-center font-bold text-lg shadow-lg`}
                  >
                    {step.step}
                  </div>
                  ...
                  {/* Icon */}
                  <div
                    className={`w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${step.color} flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                    {step.icon}
                  </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            >
              Real stories from students who transformed their learning with
              StudySync AI
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className={`group relative p-8 rounded-3xl border backdrop-blur-sm transition-all duration-700 hover:scale-105 hover:shadow-xl delay-${
                  index * 150
                } ${
                  isDark
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div
            className={`absolute top-10 left-10 w-32 h-32 rounded-full blur-3xl opacity-12 ${
          ...
          ></div>
          <div
            className={`absolute top-1/2 left-1/4 w-24 h-24 rounded-full blur-2xl opacity-8 ${
        ...
        <div className="relative container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              faster, and more efficiently with StudySync AI's revolutionary
              platform
            </p>
            ...
            {/* Trust indicators */}
            <div
              className={`grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto pt-8 border-t ${
