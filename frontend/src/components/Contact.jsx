...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contacts | StudySyncAI</title>
        <meta
          name="description"
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                >
                  ...
                  >
                    Need immediate help? Our AI chatbot is available 24/7 to
                    assist you with common questions.
                  </p>
                ...
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="group">
                        <label className="block text-sm font-medium mb-3 text-emerald-600">
                          Full Name *
                        </label>
                        <input
                          type="text"
