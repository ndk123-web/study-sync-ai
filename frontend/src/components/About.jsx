...
import { Users, TrendingUp, Clock, Brain, Rocket, Target, Shield, Zap, Heart, Award, Globe, CheckCircle } from "lucide-react";
    ...
    <>
      ...
      <div className={`min-h-screen transition-colors duration-300 ${isDark ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-900"}`}>
        ...
        <div className="container mx-auto px-4 py-20">
          {/* Mission Section */}
          <div className={`grid lg:grid-cols-2 gap-16 items-center mb-20 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div>
              ...
              <p className={`text-lg mb-6 ${isDark ? "text-gray-300" : "text-gray-600"} leading-relaxed`}>
                At StudySync AI, we believe that every student deserves a personalized learning experience. 
                Our mission is to harness the power of artificial intelligence to create adaptive, 
                intelligent study tools that grow with each learner.
              </p>
              <p className={`text-lg ${isDark ? "text-gray-300" : "text-gray-600"} leading-relaxed`}>
                We're committed to making quality education accessible, engaging, and effective for 
            ...
            <div className={`p-10 rounded-3xl ${isDark ? "bg-gray-800" : "bg-white"} shadow-2xl border ${isDark ? 'border-gray-700' : 'border-gray-100'} hover:scale-105 transition-all duration-500 group`}>
              <div className="text-center">
                ...
                <p className={`${isDark ? "text-gray-300" : "text-gray-600"} leading-relaxed`}>
                  AI-powered adaptive learning that understands your unique needs and learning patterns
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Stats Section */}
          <div className={`grid md:grid-cols-3 gap-8 mb-20 transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className={`text-center p-8 rounded-3xl ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-xl hover:scale-105 transition-all duration-300 group`}>
          ...
          <div className={`p-12 rounded-3xl ${isDark ? "bg-gray-800" : "bg-white"} shadow-2xl border ${isDark ? 'border-gray-700' : 'border-gray-100'} transition-all duration-1000 delay-1100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="group text-center">
                ...
                <h3 className={`text-xl font-semibold mb-3 group-hover:text-emerald-500 transition-colors duration-300 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                  Intelligent
                </h3>
                <p className={`${isDark ? "text-gray-300" : "text-gray-600"} leading-relaxed`}>
          ...
          <div className={`mt-20 text-center transition-all duration-1000 delay-1300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className={`p-12 rounded-3xl ${isDark ? 'bg-gradient-to-br from-emerald-900/30 to-teal-900/30' : 'bg-gradient-to-br from-emerald-50 to-teal-50'} border ${isDark ? 'border-emerald-800' : 'border-emerald-200'}`}>
              <div className="mb-8">
              ...
              <p className={`text-xl ${isDark ? "text-gray-300" : "text-gray-600"} max-w-4xl mx-auto leading-relaxed`}>
                We envision a world where personalized AI-powered education is accessible to everyone, 
                breaking down barriers and unlocking human potential through intelligent learning experiences.
              </p>
            </div>
          </div>
        </div>
