...
const Features = () => {
  ...
  const features = [
    {
      ...
      description:
        "Advanced AI algorithms that adapt to your learning style and pace for maximum efficiency",
    ...
    },
    {
      ...
      title: "Smart Notes",
      description:
        "Automatically organize and categorize your study materials with intelligent tagging",
    ...
    },
    {
      ...
      description:
        "Custom assessments based on your learning progress and knowledge gaps",
    ...
    },
    {
      ...
      description:
        "Instant suggestions and improvements for better learning outcomes",
    ...
    },
    {
      ...
      description:
        "Access your study materials anywhere, anytime, on any device seamlessly",
  ...
  return (
    <>
      <Helmet>
        <title>Features | StudySyncAI</title>
        <meta
          name="description"
          content="Discover the powerful features of StudySync AI that enhance your learning experience."
        />
      </Helmet>
      <Header />
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Discover the revolutionary features that make StudySync AI your
              ultimate learning companion
            </p>

            {/* Stats Section */}
            <div
              className={`grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto transition-all duration-1000 delay-700 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="relative mb-6">
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${feature.color} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg`}
                  >
                ...
                <p
                  className={`${
                    isDark ? "text-gray-300" : "text-gray-600"
                  } leading-relaxed group-hover:text-opacity-80 transition-all duration-300`}
                >
                  {feature.description}
                </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className={`${isDark ? "text-gray-300" : "text-gray-600"}`}>
                  Our AI understands your unique learning patterns and adapts
                  content accordingly
                </p>
              </div>
              ...
              >
                ...
                <p className={`${isDark ? "text-gray-300" : "text-gray-600"}`}>
                  Learn 3x faster with our optimized study methods and
